...
// git version baked at build time (same format as C++ MM3_VERSION)
...
export default defineConfig({
	...
	server: {
		proxy: {
			'/synth': 'http://localhost:8086',
			'/job': 'http://localhost:8086',
			'/health': 'http://localhost:8086',
			'/props': 'http://localhost:8086',
			'/logs': 'http://localhost:8086'
		}
	},
